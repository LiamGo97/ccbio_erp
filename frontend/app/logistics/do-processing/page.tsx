...
function DoProcessingPageContent() {
  ...
  // DO 처리 목록에서 실제로 사용되는 제품 목록 추출 (필터 전 전체 목록에서 추출)
    ...
    <AppLayout user={user}>
      <div className="space-y-4 pb-4">
        <div className="flex items-center justify-between gap-2 md:items-start">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">DO 처리</h1>
...
export default function DoProcessingPage() {
  return (
    <Suspense fallback={
