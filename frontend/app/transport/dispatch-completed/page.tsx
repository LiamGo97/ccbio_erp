...
function DispatchCompletedPageContent() {
    ...
    <AppLayout user={user}>
      <div className="space-y-4 pb-4">
        <div className="flex items-center justify-between gap-2 md:items-start">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">배차완료</h1>
            <p className="hidden text-muted-foreground md:block">
              배차 완료 상태의 배차 정보를 조회하고 관리합니다.
            </p>
          </div>
        </div>
